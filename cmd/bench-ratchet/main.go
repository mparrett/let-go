...
const prFastFilter = `^Benchmark(RatchetAnchor|FrameDispatch|FrameAlloc|FuncInvoke|MultiArity|VariadicInvoke|StructToRecord|RecordToStructFastPath|RecordToStructSlowPath|VarDerefRoot|VarDerefBound|MapAssoc|SeqIteration|VectorConj|VectorCreation|ProtocolDispatchMono|ProtocolDispatchBimorphic)$`
